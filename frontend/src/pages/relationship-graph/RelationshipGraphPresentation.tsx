                ...
                {Array.from(layout.entries()).map(([nodeId, point]) => {
                  ...
                  return (
                    <g
                      ...
                      aria-label={`节点 ${graphNodeLabel(node, anonymousGraphLabels)}`}
                      aria-pressed={selected}
                      onClick={(event) => {
                        event.stopPropagation();
                        if (canvas.didPan()) return;
            ...
            <div className="relationship-list">
              ...
              {pendingEdges.map((edge) => (
                ...
                >
                  ...
                  >
                    <strong>{relationLabel(edge, nodesById, anonymousGraphLabels)}</strong>
              ...
              {!pendingReviewError && !pendingEdges.length && (
                <p className="muted-copy">{pendingReviewLoading ? "正在加载待审核关系..." : "当前范围内没有待审核关系。看图不需要先审核。"}</p>
              )}
            </div>
          </section>
          ...
          <section className="panel relationship-list-panel" aria-labelledby="relationship-edge-list-title">
            <div className="panel-header">
              <div>
                ...
                <h3 id="relationship-edge-list-title">这些互动</h3>
              </div>
            </div>
            <div className="relationship-list">
              {graphEdges.map((edge) => (
          ...
          <section className="panel relationship-list-panel" aria-labelledby="relationship-node-list-title">
            <div className="panel-header">
              <div>
                ...
                <h3 id="relationship-node-list-title">这些人</h3>
              </div>
            </div>
            <div className="relationship-list">
              {modeFilteredNodes.map((node) => (
                ...
                >
                  <strong>{graphNodeLabel(node, anonymousGraphLabels)}</strong>
